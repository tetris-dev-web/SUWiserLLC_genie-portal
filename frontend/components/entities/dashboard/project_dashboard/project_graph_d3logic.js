...
export handleMouseOut(d,link,continentSquares,citySquares,projects) {
...
export addDragHandlers( simulation,circle,innerCircle,continentSquares,citySquares ) {
  const drag_start = (d) => {
