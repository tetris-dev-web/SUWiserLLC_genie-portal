    ...
    if (this.props.currentUser) {
      return (
        <div className="project-dashboard">
          ...
          <div className={this.state.currentViewId === null ? "toggle-view-options-container-graph-hidden" : "toggle-view-options-container"}>
            <div className="toggle-view-options-border-layer project">
              <ToggleOptions
