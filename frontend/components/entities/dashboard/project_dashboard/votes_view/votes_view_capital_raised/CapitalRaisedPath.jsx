...
const CapitalRaisedPath = ({d, opacity, transform}) => {
	...
	const QuestionIcon = () => (
				<svg x="0px" y="0px"
					...
					<path className="questionIcon" fill="#61ABA9" d="M480,19.04c-113.017,0-204.96,91.943-204.96,204.96c0,113.017,91.943,204.96,204.96,204.96
	...
	return (
		<g
			transform={transform}>
			<path
				className="CapitalRaisedPath"
				d={d}
				opacity={opacity}></path>
			<rect			x={lastxFactor} y={lastPoint}
								width="100px"
								height="100px"
								fill={"blue"}
								></rect>
