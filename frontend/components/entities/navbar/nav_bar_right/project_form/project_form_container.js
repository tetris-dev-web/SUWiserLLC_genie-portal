...
const mapStateToProps = (state) => {
  const projects = Object.keys(state.chain_data.projectGraph.projects).reduce(
    (pitchedProjects, projectTitle) => {
...
const mapDispatchToProps = (dispatch) => {
  return {
    createProject: (projectFactoryInstance, params, pdf_file, account) =>
      createProject(projectFactoryInstance, params, pdf_file, account),
