...
class ProjectForm extends React.Component {
  ...
  renderLatLngErrors(clicked) {
    if (
      this.state.projectData.latitude == "" &&
      this.state.projectData.longitude == "" &&
      clicked
    ) {
      return (
  ...
  calculateDiscountFactor() {
    ...
    let discountFactor = 0.5 - (capitalDeployed / 190000.0 + this.getFailedProjects() * 0.06);
      ...
      switch (fileType) {
        case "cashflowJSON":
          this.parseInputFile(file).then((cashflowData) => {
            ...
            const valuation = this.calculateNetPresentValue(
  ...
  render() {
      ...
      const CurrentQuarterSelector = () => (
        <div className="text-input-container current-quarter-input-container">
          <input
            ...
            type="number"
            value={this.state.projectData.currentQuarter}
          ...
          <div className="form-box-border-layer">
            <div className="cashflows-section">
              ...
              <DivWithCorners>
                <span className="text">
                  <CashFlowModal
                    quarter={this.state.currentQuarter ? this.state.currentQuarter : 9}
            ...
            <div className="rates-box">
              <div className="discounts-box">
                discount rate
                <div className="amount-box">{this.calculateDiscountFactor()}</div>
              </div>
                  ...
                  {this.state.projectData.projected_cashflow
                    ? "$" +
                      this.calculateNetPresentValue(
                        Object.values(this.state.projectData.projected_cashflow).slice(
    ...
    return (
      <form className="form-box p-form-box" onSubmit={this.handleSubmit}>
        ...
        <div className="blue-close-modal-button close-modal-button" onClick={this.props.closeModal}>
          &times;
        </div>
      </form>
    );
