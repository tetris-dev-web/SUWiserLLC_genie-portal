...
const PolyModal = (props) => {
  ...
  let model_link;
  if (modelId.search("-") != -1) {
    model_link = "https://3dwarehouse.sketchup.com/embed.html?mid=" + modelId;
  } else {
    model_link = "https://poly.google.com/view/" + modelId + "/embed";
  }

  return (
    <div>
      <div className="project-form-button model-id" onClick={handleClick}>
